...
export default function StockCategories() {
  ...
  const createMutation = useMutation({
    ...
    onError: () => {
      toast({ title: "Failed to create stock category", variant: "destructive" });
    },
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: () => {
      toast({ title: "Failed to update stock category", variant: "destructive" });
    },
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: () => {
      toast({ title: "Failed to delete stock category", variant: "destructive" });
    },
  });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="main-content">
        ...
        <main className="p-6">
          ...
          <div>
            <h1 className="text-3xl font-bold">Stock Categories</h1>
            <p className="text-muted-foreground">Manage inventory stock categories</p>
          </div>
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent className="max-w-md">
              <DialogHeader>
                <DialogTitle>
                  {editingCategory ? "Edit Stock Category" : "Create Stock Category"}
                </DialogTitle>
              </DialogHeader>
              <Form {...form}>
                  ...
                  {categories.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={5} className="text-center py-8">
                        No stock categories found. Create your first category to get started.
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
