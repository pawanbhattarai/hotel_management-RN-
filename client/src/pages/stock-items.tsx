      ...
      <div className="main-content">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-muted-foreground">Manage inventory stock items</p>
          </div>
                ...
                <TableBody>
                  {items.map((item: any) => (
                    <TableRow key={item.id}>
                      ...
                      <TableCell>₨. {parseFloat(item.defaultPrice || "0").toFixed(2)}</TableCell>
                      <TableCell>
                        <Badge variant={
                          parseFloat(item.currentStock || "0") <= parseFloat(item.minimumStock || "0") 
                            ? "destructive" 
                            : "secondary"
                        }>
                          {parseFloat(item.currentStock || "0") <= parseFloat(item.minimumStock || "0") 
