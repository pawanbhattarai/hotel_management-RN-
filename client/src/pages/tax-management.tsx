...
export default function TaxManagement() {
  ...
  const handleDelete = (tax: Tax) => {
    if (window.confirm(`Are you sure you want to delete "${tax.taxName}"? This action cannot be undone.`)) {
            ...
            <Card>
              <CardContent className="p-6 text-center">
                <p className="text-muted-foreground">
                  Only administrators can access the Tax/Charges management system.
                </p>
              </CardContent>
            </Card>
          </main>
            ...
            <CardContent>
              {isLoading ? (
                    ...
                    <TableBody>
                      {taxes.map((tax: Tax, index: number) => (
                        <TableRow key={tax.id}>
                          ...
                          <TableCell>
                            <Badge className={`${getStatusColor(tax.status)} text-white`}>
                          ...
                          <TableCell>
                            <div className="space-y-1">
                              ...
                              {!tax.applyToReservations && !tax.applyToOrders && (
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-medium mb-2">No Taxes/Charges Configured</h3>
                  <p className="text-muted-foreground mb-4">
                    Create your first tax or charge configuration to start applying them to reservations and orders.
                  </p>
                  <Button onClick={() => {
                    setEditingTax(null);
                    resetForm();
                      ...
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Only active taxes will be applied to new transactions
                          </p>
                        </div>
                        <FormControl>
                          <Switch
